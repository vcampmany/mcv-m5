...
from keras.layers import Input, GlobalAveragePooling2D, Flatten, Dense, Reshape, merge, Activation
from keras.layers import Convolution2D, MaxPooling2D, AtrousConvolution2D, ZeroPadding2D
...
def SSD(input_shape=(300,300,3),num_classes=80):
    """SSD architecture
    ...
    # Code based on
        https://github.com/weiliu89/caffe/tree/ssd (Original - Caffe)
    ...
    # The network consists of two main parts, a base network (VGG)
    # and auxiliary layers after de VGG.

    # Base Network (VGG)
    # The original code is the function VGGNetBody from
    ...
    # FC6 - Replace FC with fully connected
