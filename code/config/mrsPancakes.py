...
crop_size_train              = (299, 299)            # Crop size during training (Height, Width) or None
crop_size_valid              = (299, 299)            # Crop size during validation
crop_size_test               = (299, 299)            # Crop size during testing
resize_train                 = (330, 330)      # Resize the image during training (Height, Width) or None
resize_valid                 = (330, 330)      # Resize the image during validation
resize_test                  = (330, 330)      # Resize the image during testing
