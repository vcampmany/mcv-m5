...
"""
    SSD Loss function
    Code adapted from: https://github.com/rykov8/ssd_keras/blob/master/ssd_training.py 
"""
def SSDLoss(num_classes, alpha=1.0, neg_pos_ratio=2.0, background_label_id=0, negatives_for_hard=100.0):
